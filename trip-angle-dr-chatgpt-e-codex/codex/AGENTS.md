# Trip Angle Direct Response (TRM)

Skills em `.agents/skills/`. Comece pelo `agente-central-trm`. Não há subagentes: execute cada agente na própria sessão, uma etapa por vez.
...
| Quando o texto disser | No Codex faça |
|---|---|
